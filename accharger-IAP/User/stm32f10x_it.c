...
uint8_t flag_time = 0 ; //用来捕获时间的变化，第0位表示1MS定时状态，第1位表示5MS定时状态，第3位表示500MS定时状态。

uint8_t flag_1ms = 0x01;
uint8_t flag_5ms = 0x02;
uint8_t flag_500ms = 0x04;

uint16_t ref_1ms = 1;
uint16_t ref_5ms = 5;
uint16_t ref_500ms = 100;
